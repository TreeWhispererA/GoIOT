...
func SuccessArrRespond(fields interface{}, modelType string, writer http.ResponseWriter) {
	...
	switch modelType {
	case "Manufacturer":
		temp.Data = fields.([]*models.Manufacturer)
	case "Model":
		temp.Data = fields.([]*models.Model)
	case "Template":
		temp.Data = fields.([]*models.Template)
	case "DeviceTemplate":
		temp.Data = fields.([]*models.DeviceTemplate)
	case "Devices":
		temp.Data = fields.([]*models.Devices)
	case "BriefDevice":
		temp.Data = fields.([]*models.BriefPrfidDevice)
	default:
